...
var a = 4;
if (++a === 5) {
    alert("given condition for variable a is true");        //valid
}

// b 
var b = 82;
if (b++ === 83) {
    alert("given condition for variable b is true");        //Invalid
}
...
if (c === 13) {
    alert("condition 2 is true");        // valid
}
if (++c < 14) {
    alert("condition 3 is true");
}
if (c === 14) {
    alert("condition 4 is true");        //valid
}
...
// f
if ("car" < "cat") {
    alert("car is smaller than cat");        //valid
}
